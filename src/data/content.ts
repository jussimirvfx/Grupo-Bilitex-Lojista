import { FAQItem, BenefitItem, GalleryItem } from '../types';

export const HERO_CONTENT = {
  headline: "Lojista, leve moda\ninfantil e teen para\na sua loja.",
  subheadline: "Há 35 anos, o Grupo Bilitex desenvolve coleções para boutiques e multimarcas que buscam qualidade, variedade e suporte comercial em cada compra.",
  ctaText: "Quero ser lojista parceiro",
};

export const AUTHORITY_METRICS = [
  { value: "+35", label: "anos de mercado" },
  { value: "+700", label: "lojas atendidas" },
  { value: "+1.2M", label: "peças produzidas por ano" },
];
  ...
  gallery: [
    {
      ...
      alt: "Menina com chapéu e calça jeans Bakulelê"
    },
    {
      id: "bak-2",
      ...
      alt: "Menino com camisa branca e bermuda Bakulelê"
    },
    {
      id: "bak-3",
      ...
      alt: "Menina com vestido rosa Bakulelê"
    },
    {
      id: "bak-4",
    ...
    },
    {
      ...
      alt: "Menino com camiseta vermelha e bermuda Bakulelê"
    },
    {
      id: "bak-7",
      ...
      alt: "Menina com camisa branca e saia-shorts Bakulelê"
    },
    {
      id: "bak-8",
      ...
      alt: "Menino com camiseta azul e calça jeans Bakulelê"
    }
  ] as GalleryItem[]
};
...
export const BILITON_CONTENT = {
  ...
  topics: [
    ...
    "Do tamanho 12 ao 20",
    "Referência em denim",
    "Peças com atitude e personalidade"
  ],
  gallery: [
    {
      id: "bil-1",
      ...
      alt: "Modelo com camiseta bege e calça jeans Biliton"
    },
    {
      id: "bil-2",
      tag: "Foto Biliton 02",
      ...
      alt: "Modelo com camisa azul e bermuda Biliton"
    },
    {
      id: "bil-3",
      tag: "Foto Biliton 03",
      ...
      alt: "Modelo com camiseta estampada e shorts jeans Biliton"
    },
    {
      id: "bil-4",
      tag: "Foto Biliton 04",
      ...
      alt: "Modelo com camiseta azul e calça jeans Biliton"
    },
    {
      id: "bil-5",
      tag: "Foto Biliton 05",
      ...
      alt: "Modelo com blusa azul e calça branca Biliton"
    },
    {
      id: "bil-6",
      tag: "Foto Biliton 06",
      ...
      alt: "Modelo com camiseta branca e bermuda jeans Biliton"
    },
    {
      id: "bil-7",
      tag: "Foto Biliton 07",
      ...
      alt: "Modelo com camiseta bege e saia jeans Biliton"
    },
    {
      id: "bil-8",
      tag: "Foto Biliton 08",
      ...
      alt: "Modelo com camiseta preta e bermuda jeans Biliton"
    }
  ] as GalleryItem[]
};
...
export const FAQ_CONTENT: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "As condições são apresentadas pela equipe comercial de acordo com o perfil da loja e estão sujeitas à análise cadastral e financeira."
  },
  {
    id: "faq-7",
    question: "Posso trabalhar apenas com uma das marcas?",
    answer: "O interesse pode ser informado no formulário. A equipe comercial avaliará a marca e a coleção mais adequadas ao perfil da loja."
  },
  {
    id: "faq-8",
...
export const FORM_CONTENT = {
  title: "Leve o Grupo Bilitex para a sua loja",
  subtitle: "Preencha seus dados para que nossa equipe conheça o perfil da sua loja e apresente as coleções mais adequadas ao seu público.",
